...
const getValueOfProperty = (obj, objName) => {
	for (var prop in obj) {
		if (prop === objName) {
			return obj[prop]
		}
...
*/
const outside = (temperature, humidity, cloudiness) => {
